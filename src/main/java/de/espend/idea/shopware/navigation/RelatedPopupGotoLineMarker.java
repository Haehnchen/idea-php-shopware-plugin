...
public class RelatedPopupGotoLineMarker {
    ...
    public static RelatedItemLineMarkerInfo<PsiElement> getSingleLineMarker(SmartyFile smartyFile, Collection<? super LineMarkerInfo<?>> lineMarkerInfos, GotoRelatedItem gotoRelatedItem) {
