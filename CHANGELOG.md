...
## 2019.1.0
* Port automatic release changelog generation (Daniel Espendiller)
* Add Shopware MCP extensions tool (Daniel Espendiller)
* Add Shopware project settings (Daniel Espendiller)
* Support Shopware TwigFileUsage API (Daniel Espendiller)
* Add first Shopware context MCP tool (Daniel Espendiller)
* Make Toolbox integration optional (Daniel Espendiller)
* Gate default collectors to Shopware 5 (Daniel Espendiller)
* Use goto navigation for admin component slots (Daniel Espendiller)
* Add Twig config system config navigation (Daniel Espendiller)
* Fix Vue slot scope test setup (Daniel Espendiller)
* Resolve app script Twig calls semantically (Daniel Espendiller)
* Add admin component navigation targets (Daniel Espendiller)
* Add Vue slot symbols for Administration slots (Daniel Espendiller)
* Add app script Twig facade typing (Daniel Espendiller)
* Fix app script manifest permission checks (Daniel Espendiller)
* Add admin module route support (Daniel Espendiller)
* Add admin component slot resolution (Daniel Espendiller)
* Add admin mixin lookup support (Daniel Espendiller)
* Add admin component line markers (Daniel Espendiller)
* Add feature flag completion for Twig and PHP (Daniel Espendiller)
* Add DAL field completion and navigation (Daniel Espendiller)
* Hide Shopware 5 generators outside Shopware 5 projects (Daniel Espendiller)
* Fix DAL inspection entity resolution during indexing (Daniel Espendiller)
* Fix admin snippet completion closing insertion (Daniel Espendiller)
* Add deprecated Twig block inspection (Daniel Espendiller)
* Add Happy Friday access for Shopware features (Daniel Espendiller)
* Rename Shopware inspection identifiers (Daniel Espendiller)
* Document feature sources and inspection examples (Daniel Espendiller)
* Add wrapComponentConfig admin component indexing (Daniel Espendiller)
* Extend service decoration inspection (Daniel Espendiller)
* Add app script Twig variables (Daniel Espendiller)
* Add sw_icon icon-pack support (Daniel Espendiller)
* Add missing admin parent component inspection (Daniel Espendiller)
* ThemeConfig SCSS variables (Daniel Espendiller)
* Add TypeScript admin component indexing (Daniel Espendiller)
* Add DAL definition consistency inspection (Daniel Espendiller)
* Add sw_thumbnails name navigation (Daniel Espendiller)
* Add SCSS feature flag completion (Daniel Espendiller)
* Add SystemConfigService set key support (Daniel Espendiller)
* Add app script entity navigation (Daniel Espendiller)
* Add DAL id filter inspection (Daniel Espendiller)
* Add scheduled task interval inspection (Daniel Espendiller)
* Add foreign key checks inspection (Daniel Espendiller)
* Add session usage inspection (Daniel Espendiller)
* Add SystemConfig sales channel inspection (Daniel Espendiller)
* Add EntityRepository loop inspection (Daniel Espendiller)
* Add method becomes abstract inspection (Daniel Espendiller)
* Add Shopware app support (Daniel Espendiller)
* Add UserEntity store token inspection (Daniel Espendiller)
* Add default context creation inspection (Daniel Espendiller)
* Add admin component XML support (Daniel Espendiller)
* Add Criteria id constructor inspection (Daniel Espendiller)
* Remove obsolete installer project files (Daniel Espendiller)
* Add Shopware Twig feature coverage (Daniel Espendiller)
* Add administration snippet missing inspection (Daniel Espendiller)
* Add structured ThemeConfig support (Daniel Espendiller)
* Add Shopware Store composer inspection (Daniel Espendiller)
* Add activeRoute route support (Daniel Espendiller)
* Add abstract service decoration inspection (Daniel Espendiller)
* Fix inspection descriptions (Daniel Espendiller)
* Add grace period feature (Daniel Espendiller)
* update error submitter (Daniel Espendiller)
